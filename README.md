...
| **2. Bias Correction** | Propensity Score + IPW | Remove confounding selection bias (P(T \| X)) |
| **3. Causal Learning** | T-Learner (CatBoost) | Estimate counterfactual outcomes (Y1, Y0) |
